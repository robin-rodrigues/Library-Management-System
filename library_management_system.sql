...
CREATE TABLE books (
  book_id int(100) PRIMARY KEY NOT NULL ,
...
CREATE TABLE books_request (
  request_id int(10) PRIMARY KEY NOT NULL ,
...
CREATE TABLE issue_date (
  issue_id int(100) PRIMARY KEY NOT NULL ,
...
--
ALTER TABLE users
  ADD PRIMARY KEY (user_id),UNIQUE (email);
...
--
ALTER TABLE books 
  MODIFY COLUMN book_id int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
CREATE TABLE suppliers (supplier_id int(100) PRIMARY KEY NOT NULL AUTO_INCREMENT, name varchar(300) NOT NULL, phone varchar(11) NOT NULL, email varchar(300) NOT NULL, password varchar(300) NOT NULL, address varchar(300) NOT NULL);

CREATE TABLE supplier_books (
  sup_book_id int(100) PRIMARY KEY NOT NULL,
  genre varchar(300) NOT NULL,
  title varchar(300) NOT NULL,
  author varchar(300) NOT NULL,
  publisher varchar(300) NOT NULL,
...
ALTER TABLE supplier_books MODIFY COLUMN sup_book_id int(100) NOT NULL AUTO_INCREMENT;

CREATE TABLE admin_books_request(request_id int(10) PRIMARY KEY NOT NULL AUTO_INCREMENT,genre varchar(300) NOT NULL,title varchar(300) NOT NULL,author varchar(300) NOT NULL,edition int(10) NOT NULL,date date NOT NULL);

alter table books_request add publisher varchar(300) not null;

 alter table books_request add pages int(100) not null;

 alter table books_request add book_id int(100) not n

 alter table books add supplier_id int(100) not null;